...
public class SequenceBufferTests
{
    ...
    public void TestMostRecentSequence()
    {
        ...
        buffer.AddEntry(UInt16.MaxValue - 100, testValue);
        Assert.Equal(UInt16.MaxValue - 100, buffer.MostRecentSequence);
        ...
        buffer.AddEntry(UInt16.MaxValue, testValue);
        Assert.Equal(UInt16.MaxValue, buffer.MostRecentSequence);

        buffer.AddEntry(10, testValue);
        Assert.Equal(10, buffer.MostRecentSequence);

        buffer.AddEntry(UInt16.MaxValue - 50, testValue);
        Assert.Equal(10, buffer.MostRecentSequence);
